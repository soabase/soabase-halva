...
public class GenericExampleCase<A, B> implements Serializable, GenericExample<A, B>, Tuplable, ClassTuplable {
    private static final Class classTuplableClass = GenericExampleCaseAny(Any.any(), Any.any()).getClass();
    ...
    public static <A, B> AnyClassTuple<GenericExampleCase<A, B>> GenericExampleCaseAny(AnyVal<? extends A> first, AnyVal<? extends B> second) {

...
public class TestPlayingWithScalaPatternMatching
{
    ...
    */
    String parseArgument2(String arg, Object value)
    {
        ...
        return match(Tuple.Tu(arg, value))
            .caseOf(Tuple.Tu("-l", s), () -> "setLanguageTo(" + s.val() + ")")
            .caseOf(Tuple.Tu(oOrOptim, n), () -> ((0 < n.val()) && (n.val() <= 5)), () -> "setOptimizationLevelTo(" + n.val() + ")")
            .caseOf(Tuple.Tu(oOrOptim, n), () -> "badOptimizationLevel(" + n.val() + ")")
            .caseOf(Tuple.Tu(hOrHelp, v), () -> "displayHelp()")
            .caseOf(Tuple.Tu(s, v), () -> "badArgument(" + s.val() + ")")
            .get();
    }

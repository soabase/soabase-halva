...
public class Assign14<A, B, C, D, E, F, G, H, I, J, K, L, M, N>
{
    ...
    public Assign14(AnyVal<A> _1, AnyVal<B> _2, AnyVal<C> _3, AnyVal<D> _4, AnyVal<E> _5, AnyVal<F> _6, AnyVal<G> _7, AnyVal<H> _8, AnyVal<I> _9, AnyVal<J> _10, AnyVal<K> _11, AnyVal<L> _12, AnyVal<M> _13, AnyVal<N> _14)
    {
        this._1 = _1;
        this._2 = _2;
        this._3 = _3;
    ...
    public Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> from(Tuple14<A, B, C, D, E, F, G, H, I, J, K, L, M, N> from)
    {
        _1.set(from._1);
        _2.set(from._2);
        _3.set(from._3);

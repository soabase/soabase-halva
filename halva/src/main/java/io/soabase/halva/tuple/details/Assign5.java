...
public class Assign5<A, B, C, D, E>
{
    ...
    public Assign5(AnyVal<A> _1, AnyVal<B> _2, AnyVal<C> _3, AnyVal<D> _4, AnyVal<E> _5)
    {
        this._1 = _1;
        this._2 = _2;
        this._3 = _3;
    ...
    public Tuple5<A, B, C, D, E> from(Tuple5<A, B, C, D, E> from)
    {
        _1.set(from._1);
        _2.set(from._2);
        _3.set(from._3);

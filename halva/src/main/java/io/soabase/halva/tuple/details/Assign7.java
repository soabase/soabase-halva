...
public class Assign7<A, B, C, D, E, F, G>
{
    ...
    public Assign7(AnyVal<A> _1, AnyVal<B> _2, AnyVal<C> _3, AnyVal<D> _4, AnyVal<E> _5, AnyVal<F> _6, AnyVal<G> _7)
    {
        this._1 = _1;
        this._2 = _2;
        this._3 = _3;
    ...
    public Tuple7<A, B, C, D, E, F, G> from(Tuple7<A, B, C, D, E, F, G> from)
    {
        _1.set(from._1);
        _2.set(from._2);
        _3.set(from._3);

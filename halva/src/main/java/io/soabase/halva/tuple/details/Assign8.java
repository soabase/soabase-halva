...
public class Assign8<A, B, C, D, E, F, G, H>
{
    ...
    public Assign8(AnyVal<A> _1, AnyVal<B> _2, AnyVal<C> _3, AnyVal<D> _4, AnyVal<E> _5, AnyVal<F> _6, AnyVal<G> _7, AnyVal<H> _8)
    {
        this._1 = _1;
        this._2 = _2;
        this._3 = _3;
    ...
    public Tuple8<A, B, C, D, E, F, G, H> from(Tuple8<A, B, C, D, E, F, G, H> from)
    {
        _1.set(from._1);
        _2.set(from._2);
        _3.set(from._3);

...
public class Assign9<A, B, C, D, E, F, G, H, I>
{
    ...
    public Assign9(AnyVal<A> _1, AnyVal<B> _2, AnyVal<C> _3, AnyVal<D> _4, AnyVal<E> _5, AnyVal<F> _6, AnyVal<G> _7, AnyVal<H> _8, AnyVal<I> _9)
    {
        this._1 = _1;
        this._2 = _2;
        this._3 = _3;
    ...
    public Tuple9<A, B, C, D, E, F, G, H, I> from(Tuple9<A, B, C, D, E, F, G, H, I> from)
    {
        _1.set(from._1);
        _2.set(from._2);
        _3.set(from._3);
